...
See the full [Slack Bot README](https://github.com/BAHALLA/ai-agents/blob/main/agents/slack-bot/README.md) for webhook mode, Docker deployment, and configuration reference.
